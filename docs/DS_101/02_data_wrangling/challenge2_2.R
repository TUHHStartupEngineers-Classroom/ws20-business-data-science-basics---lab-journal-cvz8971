...
bike_family_tbl <- read_html("https://www.rosebikes.com/bikes") %>%
  ...
  html_attr('title') %>%          # extract the information of the id attribute
...
# Combine all Ids to one string so that we will get all nodes at once (seperated by the operator ",")
